...
import junit.tutorial.ex02.e06.ApplicationServer;
import junit.tutorial.ex02.e06.Database;
import junit.tutorial.ex02.e06.Frameworks;
...
class FrameworksTest {
	...
	@ParameterizedTest
	@CsvSource({"GlassFish, Oracle, true",
				"GlassFish, DB2, true",
